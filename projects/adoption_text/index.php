...
<section id="main-content" class="main-content container">
    <div class="image-block">
        <h2 class="section_title meet-title"><?php the_field('meet_title'); ?> <span class="alex_brush"><?php the_field('name_f'); ?></span>&nbsp;<?php the_field('meet_title_2'); ?>&nbsp;<span><?php the_field('last_f'); ?></span></h2>
    ...
    <div class="testimonials-block clearfix">
        ...
        <div class="testimonials-block_video">
            <div class="testimonial-video">
                <a href="https://youtu.be/PqBk8v4dzDg" class="vp-a test-1" target="_blank" rel="nofollow"></a>
            </div>

            <div class="testimonial-video">
                <a href="https://youtu.be/PqBk8v4dzDg" class="vp-a test-2" target="_blank" rel="nofollow"></a>

            </div>
            <div class="testimonial-video">
                <a href="<?php the_field('testimonials_3'); ?>" class="vp-a test-3" target="_blank" rel="nofollow"></a>
